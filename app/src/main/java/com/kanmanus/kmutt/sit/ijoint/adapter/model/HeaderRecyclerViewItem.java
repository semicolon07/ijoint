 ...
 */
public class HeaderRecyclerViewItem extends AbstractFlexibleItem<HeaderRecyclerViewItem.ViewHolder> {
    ...
    public boolean equals(Object o) {
        if (o instanceof HeaderRecyclerViewItem) {
            HeaderRecyclerViewItem inItem = (HeaderRecyclerViewItem) o;
